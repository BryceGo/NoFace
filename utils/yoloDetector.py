...
class yolov3Manager:
    def __init__(self, model_weights = "yolov3-tiny.weights", model_configuration = "yolov3-tiny.cfg", classes_file = "coco.names"):
        ...
        self.model_weights = os.path.join(base_path, model_weights)
        self.model_configuration = os.path.join(base_path, model_configuration)
        self.classes_file = os.path.join(base_path, classes_file)
